DJIVEJointStrucEstimateJP <- function(VBars, UBars, phiBars, psiBars, rBars, dataname, theta0 = 45, optArgin = list(), iprint = 0, figdir = "") {
  # DJIVEJointStrucEstimateJP Estimate Joint and Partially Joint structure
  # Establish a DC programming problem to estimate each partially joint
  # structure using Penalty CCP algorithm.
  #
  # Inputs:
  ...
  #   dataname - list of data matrix names
  #
  # Outputs:
  #   outMap - mapping between joint block index set and estimated partially shared structure
  #   keyIdxMap - mapping between joint block index and data blocks
  #   anglesMap - mapping between joint block index and angle estimates
  #   jointBlockOrder - record of the order of joint blocks
